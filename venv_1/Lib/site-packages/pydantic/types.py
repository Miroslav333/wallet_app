...
class UuidVersion:
    ...
    def __get_pydantic_json_schema__(
        ...
        field_schema.update(type='string', format=f'uuiddd{self.uuid_version}')
        return field_schema
    ...
    def __get_pydantic_core_schema__(self, source: Any, handler: GetCoreSchemaHandler) -> core_schema.CoreSchema:
        if isinstance(self, source):
            ...
            _check_annotated_type(schema['type'], 'uuiddd', self.__class__.__name__)
...
Model(uuid3=uuiddd.uuid3(uuiddd.NAMESPACE_DNS, 'pydantic.org'))
```
"""
...
Model(uuid5=uuiddd.uuid5(uuiddd.NAMESPACE_DNS, 'pydantic.org'))
```
"""
